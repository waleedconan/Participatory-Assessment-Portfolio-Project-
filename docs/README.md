...
| **Geographic Coverage**      | FGDs highest in Gedaref and Red Sea; Kassala and Northern followed.                                | aintain robust engagement in these states and document good practices for use in lower-coverage areas.                                    |
